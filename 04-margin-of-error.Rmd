...
```{r MCQ5}
opts_Q5 <- sample(c("If we were to increase the sample size n, the range of possible values for the margin of error would decrease.",
                    "If we lower our confidence value, say from 95% to 90%, the range of plausible values for the margin of error would decrease.",
...
**Select the incorrect statement about the p/me equation/graph.**
`r longmcq(opts_Q5)`

`r hide("Hint")`
You can play around with the equation/graph on something like Desmos online if you wish.
`r unhide()`
